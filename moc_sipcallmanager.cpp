...
template <> constexpr inline auto SipCallManager::qt_create_metaobjectdata<qt_meta_tag_ZN14SipCallManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(CallState, const QString &)>(18, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 6, 7 }, { QMetaType::QString, 8 },
        }}),
...
void SipCallManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->onCallStateChanged((*reinterpret_cast<std::add_pointer_t<CallState>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        case 7: _t->onCallMediaStateChanged(); break;
        default: ;
        }
    }
