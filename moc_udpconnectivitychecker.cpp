...
template <> constexpr inline auto UdpConnectivityChecker::qt_create_metaobjectdata<qt_meta_tag_ZN22UdpConnectivityCheckerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onHostLookup'
        QtMocHelpers::SlotData<void(const QHostInfo &)>(4, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
        // Slot 'sendProbe'
...
void UdpConnectivityChecker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onHostLookup((*reinterpret_cast<std::add_pointer_t<QHostInfo>>(_a[1]))); break;
        case 3: _t->sendProbe(); break;
        default: ;
        }
    }
