...
void SipRegistrationManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->registrationFailed((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        ...
        case 6: _t->onRetryTimerTimeout(); break;
        case 7: _t->retryRegistration((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (SipRegistrationManager::*)(const QString & , const QString & , int )>(_a, &SipRegistrationManager::registrationSucceeded, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (SipRegistrationManager::*)(const QString & , const QString & )>(_a, &SipRegistrationManager::registrationFailed, 2))
            return;
...
// SIGNAL 2
void SipRegistrationManager::registrationFailed(const QString & _t1, const QString & _t2)
{
